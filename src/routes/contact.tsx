...
function ContactPage() {
  ...
  const field =
    "w-full rounded-lg border border-[color:var(--border)] bg-transparent px-4 py-3.5 text-base text-[color:var(--forest)] focus:outline-none focus:ring-2 focus:ring-[color:var(--matcha)]";
  ...
  return (
    <main>
      <section className="container-soft py-12 md:py-16">
        ...
        <form onSubmit={submit} className="mt-10 flex max-w-2xl flex-col gap-4">
          <input
            className={field}
            placeholder="Name"
            value={form.name}
          ...
          <div className="mt-2">
            <button
              type="submit"
              disabled={loading}
              className="rounded-full px-8 py-3 text-sm font-medium text-white shadow-sm transition-transform hover:-translate-y-0.5 disabled:opacity-60"
