...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Ark Matcha is a  website for a premium ceremonial matcha brand." },
      { property: "og:description", content: "Ark Matcha is a  website for a premium ceremonial matcha brand." },
      { name: "twitter:description", content: "Ark Matcha is a  website for a premium ceremonial matcha brand." },
