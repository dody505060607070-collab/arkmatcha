...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Ark Matcha is a mobile-first e-commerce website for a premium ceremonial matcha brand." },
      { property: "og:description", content: "Ark Matcha is a mobile-first e-commerce website for a premium ceremonial matcha brand." },
      { name: "twitter:description", content: "Ark Matcha is a mobile-first e-commerce website for a premium ceremonial matcha brand." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/18927df2-b8b4-4801-945f-28da9146e3ca/id-preview-6176a9f5--e0de000f-212a-41f6-8f87-d8491fab4601.lovable.app-1782654565055.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/18927df2-b8b4-4801-945f-28da9146e3ca/id-preview-6176a9f5--e0de000f-212a-41f6-8f87-d8491fab4601.lovable.app-1782654565055.png" },
    ],
